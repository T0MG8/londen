...
@st.cache_data
def load_data_metro():
    bez_2007 = pd.read_csv("2007_Entry_Exit.csv", dtype=str, low_memory=False)
    bez_2008 = pd.read_csv("2008_Entry_Exit.csv", dtype=str, low_memory=False)
    bez_2009 = pd.read_csv("2009_Entry_Exit.csv", dtype=str, low_memory=False)
    bez_2010 = pd.read_csv("2010_Entry_Exit.csv", dtype=str, low_memory=False)
    bez_2011 = pd.read_csv("2011_Entry_Exit.csv", dtype=str, low_memory=False)
    bez_2012 = pd.read_csv("2012_Entry_Exit.csv", dtype=str, low_memory=False)
    bez_2013 = pd.read_csv("2013_Entry_Exit.csv", dtype=str, low_memory=False)
    bez_2014 = pd.read_csv("2014_Entry_Exit.csv", dtype=str, low_memory=False)
    bez_2015 = pd.read_csv("2015_Entry_Exit.csv", dtype=str, low_memory=False)
...
@st.cache_data
def load_data_fiets():
    jun2021_1 = pd.read_csv("267JourneyDataExtract26May2021-01Jun2021.csv", dtype=str, low_memory=False)
    jun2021_2 = pd.read_csv("268JourneyDataExtract02Jun2021-08Jun2021.csv", dtype=str, low_memory=False)
    jun2021_3 = pd.read_csv('269JourneyDataExtract09Jun2021-15Jun2021.csv', dtype=str, low_memory=False)
    jun2021_4 = pd.read_csv('270JourneyDataExtract16Jun2021-22Jun2021.csv', dtype=str, low_memory=False)
    jun2021_5 = pd.read_csv('271JourneyDataExtract23Jun2021-29Jun2021.csv', dtype=str, low_memory=False)
    jun2021_6 = pd.read_csv('272JourneyDataExtract30Jun2021-06Jul2021.csv', dtype=str, low_memory=False)

    dec2021_1 = pd.read_csv('294JourneyDataExtract01Dec2021-07Dec2021.csv', dtype=str, low_memory=False)
    dec2021_2 = pd.read_csv('295JourneyDataExtract08Dec2021-14Dec2021.csv', dtype=str, low_memory=False)
    dec2021_3 = pd.read_csv('296JourneyDataExtract15Dec2021-21Dec2021.csv', dtype=str, low_memory=False)
    dec2021_4 = pd.read_csv('297JourneyDataExtract22Dec2021-28Dec2021.csv', dtype=str, low_memory=False)
    dec2021_5 = pd.read_csv('298JourneyDataExtract29Dec2021-04Jan2022.csv', dtype=str, low_memory=False)

    jun2022_1 = pd.read_csv('320JourneyDataExtract01Jun2022-07Jun2022.csv', dtype=str, low_memory=False)
    jun2022_2 = pd.read_csv('321JourneyDataExtract08Jun2022-14Jun2022.csv', dtype=str, low_memory=False)
    jun2022_3 = pd.read_csv('322JourneyDataExtract15Jun2022-21Jun2022.csv', dtype=str, low_memory=False)
    jun2022_4 = pd.read_csv('323JourneyDataExtract22Jun2022-28Jun2022.csv', dtype=str, low_memory=False)
    jun2022_5 = pd.read_csv('324JourneyDataExtract29Jun2022-05Jul2022.csv', dtype=str, low_memory=False)

    dec2022_1 = pd.read_csv('346JourneyDataExtract28Nov2022-04Dec2022.csv', dtype=str, low_memory=False)
    dec2022_2 = pd.read_csv('347JourneyDataExtract05Dec2022-11Dec2022.csv', dtype=str, low_memory=False)
    dec2022_3 = pd.read_csv('348JourneyDataExtract12Dec2022-18Dec2022.csv', dtype=str, low_memory=False)
    dec2022_4 = pd.read_csv('349JourneyDataExtract19Dec2022-25Dec2022.csv', dtype=str, low_memory=False)
    dec2022_5 = pd.read_csv('350JourneyDataExtract26Dec2022-01Jan2023.csv', dtype=str, low_memory=False)

    jun2023_1 = pd.read_csv('372JourneyDataExtract29May2023-04Jun2023.csv', dtype=str, low_memory=False)
    jun2023_2 = pd.read_csv('373JourneyDataExtract05Jun2023-11Jun2023.csv', dtype=str, low_memory=False)
    jun2023_3 = pd.read_csv('374JourneyDataExtract12Jun2023-18Jun2023.csv', dtype=str, low_memory=False)
    jun2023_4 = pd.read_csv('375JourneyDataExtract19Jun2023-30Jun2023.csv', dtype=str, low_memory=False)

    dec2023_1 = pd.read_csv('385JourneyDataExtract01Dec2023-14Dec2023.csv', dtype=str, low_memory=False)
    dec2023_2 = pd.read_csv('386JourneyDataExtract15Dec2023-31Dec2023.csv', dtype=str, low_memory=False)
